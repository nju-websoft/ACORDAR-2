...
def main(cfg: DictConfig):
    ...
    logger.info(f"lwq_log: {cfg.encoder.encoder_model_type} {cfg.encoder.sequence_length}")
    ...
    print(f"cfg.insert_title: {cfg.insert_title}")
    data = gen_ctx_vectors(cfg, shard_passages, encoder, tensorizer, cfg.insert_title)#True)
