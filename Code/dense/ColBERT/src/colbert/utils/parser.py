...
class Arguments():
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--epoch',dest='epoch',default=1,type=int)
    ...
    def add_training_input(self):
        ...
        self.add_argument('--valid_triples',dest='valid_triples',required=True)
        self.add_argument('--valid_queries',dest='valid_queries',required=True)
